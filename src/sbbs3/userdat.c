...
/****************************************************************************/
static list_node_t* login_attempted(link_list_t* list, union xp_sockaddr* addr)
{
	list_node_t*		node;
...
/****************************************************************************/
long DLLCALL loginAttempts(link_list_t* list, union xp_sockaddr* addr)
{
	long				count=0;
	list_node_t*		node;
...
/****************************************************************************/
void DLLCALL loginSuccess(link_list_t* list, union xp_sockaddr* addr)
{
	list_node_t*		node;
...
/****************************************************************************/
ulong DLLCALL loginFailure(link_list_t* list, union xp_sockaddr* addr, const char* prot, const char* user, const char* pass)
{
	list_node_t*		node;
