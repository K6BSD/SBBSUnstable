...
DLLEXPORT long				DLLCALL loginAttempts(link_list_t*, union xp_sockaddr*);
DLLEXPORT void				DLLCALL	loginSuccess(link_list_t*, union xp_sockaddr*);
DLLEXPORT ulong				DLLCALL loginFailure(link_list_t*, union xp_sockaddr*, const char* prot, const char* user, const char* pass);
